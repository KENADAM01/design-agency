    ...
    <>
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            {isSubmitted ? (
                <div className="p-4 mb-8 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 text-center font-medium" role="alert">
                    Form sent successfully! We will get back to you soon.
                </div>
            ) : null}
            ...
            <form action="#" onSubmit={handleSubmit} className="space-y-8">
                ...
                <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-purple-700 sm:w-fit hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800 transition-colors">Send message</button>
            </form>
        </div>
      </section>
    </>
